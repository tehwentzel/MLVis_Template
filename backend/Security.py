...
#example file for saving and checking a generic login
#uses hidden data folder, saving hash dictionary in data/hashes.pk 
#and secret key in data/secret_key.txt
#(I don't remember how to make a secret key)
...
def save_account(username, password,current_passwords  = None,current_password_file = '../data/hashes.pk',overwrite=False):
    flag = True
...
def check_password(username, password, current_passwords = None, pfile='../data/hashes.pk'):
    if current_passwords is None:
        try:
